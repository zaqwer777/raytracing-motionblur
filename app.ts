...
function defaultScene(): rt.Scene {
    return {
        things: [new rt.Plane(new rt.Vector(0.0, 1.0, 0.0), 0.0, Surfaces.checkerboard),
                 new rt.Sphere(new rt.Vector(0.0, 1.0, -0.25), 1.0, Surfaces.shiny), // big
                 new rt.Sphere(new rt.Vector(-1.0, 0.5, 1.5), 0.5, Surfaces.shiny)], // small sphere
        lights: [{ pos: new rt.Vector(-2.0, 2.5, 0.0), color: new rt.Color(0.49, 0.07, 0.07) }, // R
                 { pos: new rt.Vector(1.5, 2.5, 1.5), color: new rt.Color(0.07, 0.07, 0.49) }, // B
                 { pos: new rt.Vector(1.5, 2.5, -1.5), color: new rt.Color(0.07, 0.49, 0.071) }, // G 
                 { pos: new rt.Vector(0.0, 3.5, 0.0), color: new rt.Color(0.21, 0.21, 0.35) }], // white
        camera: new rt.Camera(new rt.Vector(3.0, 2.0, 4.0), new rt.Vector(-1.0, 0.5, 0.0))
    };
}

function newScene(): rt.Scene {
    return {
        things: [new rt.Plane(new rt.Vector(0.0, 1.0, 0.0), 0.0, Surfaces.checkerboard),
                 new rt.Sphere(new rt.Vector(1.2, 0.4, -.4), 0.3, Surfaces.shiny), // left sphere
                 new rt.Sphere(new rt.Vector(-1.5, 0.6, 2.5), 0.7, Surfaces.shiny)], // right sphere
...
function exec() {
    ...
    var sphere2 = <rt.Sphere>scene.things[2];
